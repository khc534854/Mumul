...
// Sets default values
AFeedbackObjectActor::AFeedbackObjectActor()
{
...
void AFeedbackObjectActor::BeginPlay()
{
	Super::BeginPlay();

	if (CollisionComp)
	{
		CollisionComp->OnComponentBeginOverlap.AddDynamic(this, &AFeedbackObjectActor::OnOverlapBegin);
		CollisionComp->OnComponentEndOverlap.AddDynamic(this, &AFeedbackObjectActor::OnOverlapEnd);
	}
...
// Called every frame
void AFeedbackObjectActor::Tick(float DeltaTime)
{
